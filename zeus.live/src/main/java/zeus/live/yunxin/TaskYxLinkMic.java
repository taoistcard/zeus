...
public class TaskYxLinkMic implements Runnable {
	...
	public TaskYxLinkMic(String roomId, String accId, String name, String face, int vip, long vipDeadLine, int guard,
			long guardDeadLine, long richScore, long score, int fansClub, String clubName, int clubLevel,
